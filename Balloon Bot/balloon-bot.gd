...
## is over.
export var gravity_fall_multiplier: float = 2.5
...
export var vertical_terminal_velocity: float = 750.0
...
export var jump_release_stop_multiplier: float = 0.6
...
# Godot 3.5
export var global_gravity = 1000
